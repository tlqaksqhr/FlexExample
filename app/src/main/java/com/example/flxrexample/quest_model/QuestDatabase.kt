...
@Database(entities = [(Quest::class),(QuestConstraint::class),(Review::class),(QuestAuthImage::class),(StarAccount::class)], version = 1)
...
abstract class QuestDatabase : RoomDatabase() {
    ...
    abstract fun starAccountDao(): StarAccountDao
}